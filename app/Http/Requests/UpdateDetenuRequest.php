...
class UpdateDetenuRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'numero_ecrou' => ['required', 'string', 'max:50', Rule::unique('detenus', 'numero_ecrou')->ignore($detenuId)],
            ...
            'numero_cni' => ['nullable', 'string', 'max:255', Rule::unique('detenus', 'numero_cni')->ignore($detenuId)],
            'numero_passeport' => ['nullable', 'string', 'max:255', Rule::unique('detenus', 'numero_passeport')->ignore($detenuId)],
